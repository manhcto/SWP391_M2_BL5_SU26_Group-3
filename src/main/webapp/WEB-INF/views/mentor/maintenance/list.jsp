...
<div class="app-shell">
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="side-nav">
            ...
            <a class="nav-link" href="${pageContext.request.contextPath}/mentor/dashboard"><svg><use href="#i-clipboard"/></svg><span>Lab Requests</span></a>
            <a class="nav-link" href="${pageContext.request.contextPath}/mentor/dashboard"><svg><use href="#i-users"/></svg><span>Students</span></a>
            <a class="nav-link" href="${pageContext.request.contextPath}/mentor/dashboard"><svg><use href="#i-box"/></svg><span>Assets</span></a>
            <a class="nav-link" href="${pageContext.request.contextPath}/mentor/dashboard"><svg><use href="#i-calendar"/></svg><span>Asset Usage</span></a>
            <a class="nav-link" href="${pageContext.request.contextPath}/mentor/dashboard"><svg><use href="#i-inspect"/></svg><span>Inspections</span></a>
            <a class="nav-link" href="${pageContext.request.contextPath}/mentor/dashboard"><svg><use href="#i-alert"/></svg><span>Incidents</span></a>
            <a class="nav-link" href="${pageContext.request.contextPath}/mentor/dashboard"><svg><use href="#i-list"/></svg><span>Responsibilities</span></a>
            <a class="nav-link active" href="${pageContext.request.contextPath}/mentor/maintenance" aria-current="page"><svg><use href="#i-wrench"/></svg><span>Maintenance</span><span class="nav-count">${records.size()}</span></a>
            <a class="nav-link" href="${pageContext.request.contextPath}/mentor/dashboard"><svg><use href="#i-trash"/></svg><span>Disposal</span></a>
            <a class="nav-link" href="${pageContext.request.contextPath}/mentor/dashboard"><svg><use href="#i-users"/></svg><span>My Profile</span></a>
        </nav>
    ...
    <main class="main-content">
        <header class="topbar">
            ...
            <div class="topbar-actions">
                ...
                <div class="top-profile"><div class="avatar">MA</div><span>Minh Anh</span></div>
            </div>
        </header>
