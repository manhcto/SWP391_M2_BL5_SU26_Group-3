        ...
        <header class="topbar">
            <div class="heading-wrap">
                ...
                <div><h1>Chi tiết trách nhiệm</h1>
                    <p>Sự cố, thực tập sinh, lượt sử dụng, bằng chứng và kết quả xử lý liên quan</p></div>
            </div>
            <div class="topbar-actions"><a class="btn-secondary"
                                           href="${pageContext.request.contextPath}/mentor/responsibilities">‹ Quay lại</a><a class="primary-button"
                           href="${pageContext.request.contextPath}/mentor/responsibilities/${responsibility.responsibilityId}/edit">Sửa</a>
            </div>
        </header>
        <section class="content-area"><c:if test="${not empty param.success}">
            <div class="success-message">Đã lưu hồ sơ trách nhiệm.</div>
        </c:if>
