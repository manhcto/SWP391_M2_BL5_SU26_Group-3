            ...
            <section class="dashboard-grid">
                ...
                <article class="panel">
                    ...
                    <div class="intern-actions">
                        ...
                        <a class="intern-action" href="${pageContext.request.contextPath}/lab-manager/maintenance"><span class="intern-action-icon gold"><svg><use href="#i-wrench"/></svg></span><span><strong>Bảo trì</strong><small>Duyệt và cập nhật phiếu sửa chữa</small></span></a>
