        ...
        <%@ taglib prefix="fmt" uri="jakarta.tags.fmt" %>
            <%@ taglib prefix="app" uri="/WEB-INF/app.tld" %>
                ...
                <head>
                    ...
                    <title>${formMode == 'edit' ? 'Chỉnh sửa lịch bảo trì' : 'Lên lịch bảo trì định kỳ'} | LAB Asset
                    </title>
                            ...
                            <main class="main-content">
                                <header class="topbar">
                                    <div class="heading-wrap">
                                        ...
                                        <div>
                                            <h1>${formMode == 'edit' ? 'Chỉnh sửa lịch bảo trì' : 'Lên lịch bảo trì định
                                                kỳ mới'}</h1>
                                            <p>Lập kế hoạch bảo dưỡng định kỳ để đảm bảo thiết bị phòng lab luôn hoạt
                                                động ổn định</p>
                                        </div>
                                    </div>
                                ...
                                <section class="content-area">
                                    ...
                                    <div class="form-card">
                                        <div
                                            style="margin-bottom: 20px; border-bottom: 1px solid #f3f4f6; padding-bottom: 12px;">
                                            <h3 style="margin: 0; font-size: 18px; color: #111827;">
                                                ${formMode == 'edit' ? 'Cập nhật thông tin lịch bảo trì' : 'Thông tin kế
                                                hoạch bảo trì định kỳ'}
                                            </h3>
                                            <p style="margin: 4px 0 0 0; font-size: 13px; color: #6b7280;">
                                                Điền đầy đủ thông tin thiết bị và ngày dự kiến thực hiện. Hệ thống sẽ tự
                                                động nhắc nhở khi đến hạn.
                                            </p>
                                        </div>
                                        ...
                                        <form method="post" action="${pageContext.request.contextPath}/lab-manager/maintenance?csrfToken=${sessionScope.csrfToken}">
                                            ...
                                            <input type="hidden" name="action"
                                                value="${formMode == 'edit' ? 'updateSchedule' : 'createSchedule'}">
                                            ...
                                            <div class="form-grid">
                                                <div class="form-group full-width">
                                                    ...
                                                    <input class="form-control" type="text" name="title" required
                                                        maxlength="255" value="<c:out value='${schedule.title}'/>"
                                                ...
                                                <div class="form-group full-width">
                                                    ...
                                                    <select class="form-control" name="assetTarget" required>
                                                        <option value="">-- Chọn cá thể thiết bị trong phòng lab --
                                                        </option>
                                                        <c:forEach var="a" items="${schedulableAssets}">
                                                            <c:set var="targetVal"
                                                                value="${a.assetId}:${not empty a.itemCode ? a.itemCode : ''}" />
                                                            <c:set var="isSelected"
                                                                value="${not empty schedule and schedule.assetId == a.assetId and (empty schedule.itemCode or empty a.itemCode or schedule.itemCode == a.itemCode)}" />
                                                ...
                                                <div class="form-group">
                                                    <label>Ngày dự kiến thực hiện <span
                                                            class="required">*</span></label>
                                                    <input class="form-control" type="date" name="scheduledDate"
                                                        required value="${schedule.scheduledDate}">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="number" name="estimatedCost"
                                                        ...
                                                        value="${schedule.estimatedCost}" placeholder="Ví dụ: 300000">
                                                </div>
