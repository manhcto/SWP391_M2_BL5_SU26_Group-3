...
<div class="app-shell">
    ...
    <main class="main-content">
        ...
        <section class="content-area">
            <div class="content-heading"><div><p class="eyebrow">CỔNG QUẢN LÝ PHÒNG LAB</p><h2>Hồ sơ thanh lý</h2></div><a class="primary-button" href="${pageContext.request.contextPath}/lab-manager/disposals/new"><svg><use href="#i-plus"/></svg>Tạo hồ sơ thanh lý</a></div>
