...
<!DOCTYPE html><html lang="vi"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Trách nhiệm của tôi | LAB Asset</title><link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/mentor-dashboard.css"></head>
<body class="intern-dashboard-page"><c:set var="activeMenu" value="responsibilities" scope="request"/>
<div class="app-shell">
    ...
    <main class="main-content">
        <header class="topbar">
            <div class="heading-wrap">
                ...
                <div><h1>Hồ sơ trách nhiệm và bồi thường của tôi</h1>
                    <p>Xem kết luận điều tra, nhận định và quyết định trách nhiệm của người hướng dẫn</p></div>
            </div>
        ...
        <section class="content-area">
            <div class="content-heading">
                <div><p class="eyebrow">LIABILITY</p>
                    <h2>Hồ sơ trách nhiệm của tôi (${responsibilities.size()})</h2></div>
            </div>
            <form class="filter-bar" method="get" action="${pageContext.request.contextPath}/intern/responsibilities">
                <div class="filter-group"><input class="form-control" type="search" name="keyword"
                                                 ...
                                                 placeholder="Tìm theo sự cố, thiết bị hoặc kết luận"
            ...
            <article class="panel"><c:choose><c:when test="${empty responsibilities}">
                <div class="empty-box">
                    ...
                    <p>Chỉ hiển thị hồ sơ trách nhiệm liên kết với hồ sơ thực tập sinh của bạn.</p></div>
            </c:when><c:otherwise>
                        ...
                        <c:forEach var="r" items="${responsibilities}">
                            <tr>
                                ...
                                <td><span class="severity ${r.incidentSeverity.toLowerCase()}"><c:out
                                        value="${app:label(r.incidentSeverity)}"/></span></td>
                                ...
                                <td><a class="btn-action btn-action-primary"
                                       href="${pageContext.request.contextPath}/intern/responsibilities/${r.responsibilityId}">Xem</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
