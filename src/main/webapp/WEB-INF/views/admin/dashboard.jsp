    ...
    <main class="main-content">
        ...
        <section class="content-area">
            ...
            <div class="stats-grid">
                ...
                <a class="stat-card stat-purple" href="${pageContext.request.contextPath}/admin/users?status=INACTIVE"><div class="stat-icon"><svg><use href="#i-users"/></svg></div><div><strong><c:out value="${inactiveAccountCount}"/></strong><span>Tài khoản đã khóa</span><small>Cần quản trị viên kiểm tra trạng thái</small></div></a>
