...
public final class Authorization {
	private static final Map<String, Set<Permission>> ROLE_PERMISSIONS = Map.of("ADMIN",
			...
			permissions(Permission.DASHBOARD_MENTOR, Permission.INTERN_LIST_VIEW, Permission.INTERN_LIST_EDIT,
					Permission.ASSET_VIEW, Permission.ASSET_USAGE_VIEW, Permission.INCIDENT_VIEW,
					Permission.INCIDENT_REPORT, Permission.INCIDENT_REVIEW, Permission.RESPONSIBILITY_VIEW,
					Permission.RESPONSIBILITY_ASSESS, Permission.MAINTENANCE_VIEW, Permission.MAINTENANCE_REQUEST,
					Permission.DISPOSAL_VIEW, Permission.DISPOSAL_REQUEST, Permission.PASSWORD_RESET_REQUEST,
					Permission.PASSWORD_CHANGE),
			"LAB_MANAGER",
			permissions(Permission.DASHBOARD_LAB_MANAGER, Permission.INTERN_LIST_VIEW, Permission.ASSET_VIEW,
					Permission.ASSET_MANAGE, Permission.ASSET_USAGE_VIEW, Permission.INCIDENT_VIEW,
					Permission.INCIDENT_RESOLVE, Permission.RESPONSIBILITY_VIEW, Permission.RESPONSIBILITY_ASSESS,
					Permission.MAINTENANCE_VIEW, Permission.MAINTENANCE_PROCESS, Permission.DISPOSAL_VIEW,
					Permission.DISPOSAL_REVIEW, Permission.DISPOSAL_COMPLETE, Permission.PASSWORD_RESET_REQUEST,
					Permission.PASSWORD_CHANGE),
			"INTERN",
			permissions(Permission.DASHBOARD_INTERN, Permission.ASSET_VIEW, Permission.ASSET_USAGE_VIEW,
					Permission.ASSET_USAGE_BORROW, Permission.ASSET_USAGE_RETURN, Permission.INCIDENT_VIEW,
					Permission.INCIDENT_REPORT, Permission.RESPONSIBILITY_VIEW));
